...
exog.columns = ['ln_lag_exports', 'REER_percent_change', 'ln_labor', 'GDP_anual_growth', 'GDP_per_capita_annual_growth', 'export_share_of_GDP', 'unemployment_rate', 'winter', 'spring', 'summer']
...
exog_2.columns = ['ln_lag_imports', 'REER_percent_change', 'ln_labor', 'GDP_anual_growth', 'GDP_per_capita_annual_growth', 'import_share_of_GDP', 'unemployment_rate', 'winter', 'spring', 'summer']
