...
dep = analysis_df["Exports percent change"]
...
# Define the dependent variable.
dep_2 = analysis_df["Imports percent change"]
...
with open("results/exports_new_regression_1_summary.txt", "w") as f:
...
# Save as image
plt.savefig("png_results/exports_new_regression_1_summary.png", bbox_inches='tight', dpi=300)



with open("results/imports_new_regression_1_summary.txt", "w") as f:
...
# Save as image
plt.savefig("png_results/imports_new_regression_1_summary.png", bbox_inches='tight', dpi=300)
...
exog_3.columns = ['official_exchange_rate_percent_change', 'CPI_percent_change', 'ln_labor', 'GDP_anual_growth', 'GDP_per_capita_annual_growth', 'import_share_of_GDP', 'unemployment_rate', 'winter', 'spring', 'summer']

exog_3 = sm.add_constant(exog_3)

# Define the dependent variable.
dep_3 = analysis_df["Net Exports percent change"]
...
# Save as image
plt.savefig("png_results/net_exports_new_regression_1_summary.png", bbox_inches='tight', dpi=300)