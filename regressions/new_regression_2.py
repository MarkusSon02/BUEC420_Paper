...
exog.columns = ['official_exchange_rate_percent_change', 'CPI_percent_change', 'ln_labor', 'GDP_annual_growth', 'GDP_per_capita_annual_growth', 'export_share_of_GDP', 'unemployment_rate', 'winter', 'spring', 'summer', "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018"]
...
exog_2.columns = ['official_exchange_rate_percent_change', 'CPI_percent_change', 'ln_labor', 'GDP_annual_growth', 'GDP_per_capita_annual_growth', 'import_share_of_GDP', 'unemployment_rate', 'winter', 'spring', 'summer', "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018"]
...
all_vars = [
    'const',
    'official_exchange_rate_percent_change',
    'CPI_percent_change',
    'ln_labor',
    'GDP_annual_growth',
...
# Save to LaTeX
with open("results/formatted_table_new_regression_2.tex", "w") as f:
    f.write(latex_table)