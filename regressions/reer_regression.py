...
exog.columns = ['REER_percent_change', 'ln_labor', 'GDP_annual_growth', 'GDP_per_capita_annual_growth', 'export_share_of_GDP', 'unemployment_rate', 'winter', 'spring', 'summer', "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018"]
...
exog_vars_2 = ["Real Effective Exchange Rate percent change", 'ln_Labor', "GDP growth (annual %) [NY.GDP.MKTP.KD.ZG]", "GDP per capita growth (annual %) [NY.GDP.PCAP.KD.ZG]", "Imports of goods and services (% of GDP) [NE.IMP.GNFS.ZS]", "Unemployment, total (% of total labor force) (modeled ILO estimate) [SL.UEM.TOTL.ZS]", "Winter", "Spring", "Summer", "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018"]

# Create the exogenous DataFrame and add a constant.
exog_2 = analysis_df[exog_vars_2]

exog_2.columns = ['REER_percent_change', 'ln_labor', 'GDP_annual_growth', 'GDP_per_capita_annual_growth', 'import_share_of_GDP', 'unemployment_rate', 'winter', 'spring', 'summer', "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018"]
...
# Save to LaTeX
with open("results/formatted_table_REER_regression.tex", "w") as f:
    f.write(latex_table)